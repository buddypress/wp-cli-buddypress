 ...
 *
 *     # Set group meta
 *     $ wp group meta set 123 description "Mary is a Group user."
 *     Success: Updated custom field 'description'.
 *
 *     # Get group meta
 *     $ wp group meta get 123 description
 *     Mary is a Group user.
 *
 *     # Update group meta
 *     $ wp group meta update 123 description "Mary is an awesome Group user."
 *     Success: Updated custom field 'description'.
 *
 *     # Delete group meta
